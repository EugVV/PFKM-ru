...
* Другие изменения в переводе:
  ...
  * монстры: Acid-imbued Giant Slug – гигантский кислотный слизняк (был гигантский кислототелый слизняк), construct – конструкт (была конструкция), deva – дэв (было даэва), Frost Giant – везде морозный великан (местами были ледяные гиганты/морозные гиганты);
